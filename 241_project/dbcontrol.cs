...
namespace _241_project
{
    class dbcontrol
    {
        SqlConnection cn = new SqlConnection(@"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename=C:\Users\Zainah\source\repos\241_project\241_project\dbtest.mdf;Integrated Security = True");
        SqlCommand cm;
